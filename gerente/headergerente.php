        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="RegistoFuncionario.php">Registar Funcionario</a></li>
                 <li class="nav-item"><a class="nav-link" href="ListaFuncionario.php">Listar Funcionarios</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="RegistoProduto.php">Registar Produto</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="EntradaEstoque.php">Entrada de Estoque</a></li>
                  <li class="nav-item"> <a class="nav-link" href="SaidaEstoque.php">Saida de Estoque</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="RegistoParceiro.php"> Registar Parceiro </a></li>
                <li class="nav-item"> <a class="nav-link" href="ListaParceiro.php"> Listar Parceiro </a></li>
              </ul>
            </div>
          </li>
